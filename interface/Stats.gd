...
func _process(delta: float) -> void:
	...
	var player_temp_percentage = (warm_body.max_body_temperature - warm_body.temperature) / (warm_body.max_body_temperature - warm_body.minimun_body_temperature)
	temp_texture_progress.value = 100 * player_temp_percentage
	print(player_temp_percentage)
